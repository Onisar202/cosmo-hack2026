...
Сводная таблица и честные выводы — **[`experiments/out/summary.md`](experiments/out/summary.md)**,
собирается программно из уже посчитанных метрик (не независимое
утверждение поверх них).
