...
нормализует (см. .ai/main-prompt.md, §8). Коннекторы: ``swpc.py`` (NOAA
SWPC, поток протонов) и ``orbit.py`` (CelesTrak GP/TLE МКС); остальные
добавляются последующими задачами по зоне 1.
"""
