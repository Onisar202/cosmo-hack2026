...
источник орбиты: `nasa-iss-oem` / `nasa-iss-oem-history` / `EME2000` вместо
...
- `result.orbit.source` ∈ `celestrak | space-track | nasa-iss-oem`.
  `nasa-iss-oem` (FN-41) — датированный выпуск NASA TOPO CCSDS OEM: с этим
